...
def run(max_iters=None):
    ...
    max_iters : int or None
        Run forever when None (normal operation).  When set, run exactly that
        many loop iterations and return — used by the host test harness to
        exercise the loop without an infinite block.
    """
